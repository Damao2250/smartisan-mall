  ...
  <div class="w" style="padding-bottom: 100px;">
    <y-shelf title="支付订单">
      <div slot="content">
        ...
        <div class="pay-type">
          ...
          <div class="pay-item">
            <div :class="{active:payType==1}" @click="payType=1"><img src="@/assets/images/alipay@2x.png" alt=""></div>
            <div :class="{active:payType==2}" @click="payType=2"><img src="@/assets/images/weixinpay@2x.png" alt="">
            </div>
          </div>
        </div>
    ...
    <div class="confirm-goods-table">
      <div class="cart-items" v-for="(item,i) in cartList" :key="i">
        <div class="name" v-if="item.checked === '1'">
